...
const JoinUS = () => {
  ...
  // Reference to the JOIN US h2 element
  const joinUsHeadingRef = React.useRef(null);

  useEffect(() => {
    // Scroll to the JOIN US heading when the component mounts or the link is clicked
    if (joinUsHeadingRef.current) {
      joinUsHeadingRef.current.scrollIntoView({ behavior: "smooth" });
    }
  }, []);
  ...
  return (
    <div id="join-us">
      ...
      <div className="py-12">
        <section className="bg-gradient-to-b from-red-600 to-blue-900 text-white text-center p-20  relative">
        <h2 ref={joinUsHeadingRef} className="text-3xl font-bold mb-6">JOIN US</h2>
